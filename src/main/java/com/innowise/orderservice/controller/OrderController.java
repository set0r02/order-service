...
public class OrderController {
    ...
    public ResponseEntity<OrderOutputDto> getOrderById(@PathVariable Long id){
        OrderOutputDto orderOutputDto = orderService.getOrderById(id);
        return ResponseEntity.status(HttpStatus.OK).body(orderOutputDto);
    }

    @GetMapping
    public ResponseEntity<Page<OrderOutputDto>> getOrders(Pageable pageable,
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity<OrderOutputDto> deleteOrderById(@PathVariable Long id){
